...
QByteArray parsing(QString client_data)
{
    ...
    else if (func_name.compare("reg") == 0)
    {
        ...
        if (d == "no_roots"){
            ...
            return (QString("x = ") + QString::number(-((client_data_list.at(1)).toFloat()) / (2 * (client_data_list.at(0)).toFloat()))).toUtf8();
        }
        else {
            ...
            temp2 = (bisection_method((client_data_list.at(0)).toFloat(), (client_data_list.at(1)).toFloat(),
                           0          (client_data_list.at(2)).toFloat(), 0, 1000));
            if(temp1 == "nan" || temp2 == "nan"){
                return QString("0").toUtf8();
            }
            else{
                return QString("x1 = "+ temp1 + " " + "x2 = "+temp2).toUtf8();
            }
        }
    }
    else {
